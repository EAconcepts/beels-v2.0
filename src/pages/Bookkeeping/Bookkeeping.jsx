...
import heroImg from "../../assets/images/book-hero.png"
  ...
  return (
    <div>
      ...
      <div className="mt-[54px] px-[20px]">
        <Hero heroImg ={heroImg} heading={"Bookkeeping"}/>
      </div>
      {/* Features */}
      ...
      <div className="px-[20px]">
        <BIRMgt heading={"Free Up Your Time: Effortless Receipt Management with "} />
      </div>
