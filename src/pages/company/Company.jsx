  ...
  return (
    <div className="flex flex-col font-karla bg-[#F4FDED] pt-[54px]">
      ...
      <div className="mt-[54px] px-[20px]">
        <p className="font-[700] text-[32px] leading-[37.41px] text-black text-center">
        ...
        <div className="relative z-0 w-fit mt-[74px]">
          ...
          <img src={curve} alt="curve" className="absolute z-0 top-[-44px]" />
          <img
            src={curve}
            alt="curve"
            className="absolute right-0 z-0 bottom-[-40px] rotate-180"
          />
        </div>
      </div>
      {/* Who we are & Mission */}
      <div className="flex flex-col px-[20px] gap-y-[32px] mt-[117px]">
        {/* Who we are */}
        <div className="flex flex-col gap-y-[24px]">
          <h2 className="font-[700] text-[32px] leading-[37.41px] text-center text-[#082C25]">
            Who we are
          </h2>
          <p className="font-[500]  text-[16px] leading-[28px] text-center text-[#082C25]">
      ...
      <div className="bg-white">
        <div className="bg-white pt-[71px] px-[14px]">
          <h4 className="text-greenPrimary text-[32px] leading-[37.41px] text-center font-[700]">
            With Beels, each step is designed to simplify and enhance your
            experience
          </h4>
          <p className="text-greenPrimary text-[16px] font-[500] leading-[28px] text-center mt-[21px]">
        ...
        {/*  Features*/}
        <div className="mt-[20px] px-[20px] pb-[91px]">
          {features?.map((feat, index) => (
            <div
              key={index}
              className="flex flex-col pt-[31.26px] text-center gap-y-[31.26px] items-center border-r-[0.16px] border-b-[0.16px] pb-[37.72px]  border-[#082C2599]"
            >
              <img src={feat.icon} className="" />
              <div className="flex flex-col gap-y-[18.76px] items-center">
                <h3 className="font-[700] text-[32px] leading-[21.88px] text-center text-[#030F0D]">
                  {feat.title}
                </h3>
                <p className=" text-[16px] font-[400] leading-[20.32px]  text-greenPrimary ">
                  {feat.content}
                </p>
              </div>
            </div>
      ...
      {/* Contact */}
      <div className="pl-[16px] pt-[126.93px] pr-[21px]">
        <div className="relative">
          <img src={contact} className=" z-10 relative" />
          <div className="w-[284px] z-0 h-[197px] bg-[#E8FBD9] absolute bottom-[-40px] right-0"></div>
        </div>
        <div className="flex flex-col items-center  mt-[85.88px]">
          <Button
            className={
          ...
          <h3 className="text-[32px] font-[700] leading-[37.41px] text-greenPrimary text-center mt-[26px]">
          ...
          {contactList?.map((cont, index) => (
            <div key={index} className="flex items-start gap-x-[24px]">
              ...
              <div className="flex flex-col gap-y-[18px]">
                ...
                <p className="font-[400] text-[20px] leading-[28px] text-[#082C25]">
                  {cont.desc}
                </p>
              </div>
            </div>
